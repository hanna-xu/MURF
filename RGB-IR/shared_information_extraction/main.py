...
data1_path = 'aligned_RGB_IR_part1.h5'
data2_path = 'aligned_RGB_IR_part2.h5'
...
def main():
	with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
		...
		IR_input = tf.compat.v1.placeholder(tf.float32, shape=(model.batchsize, patch_size, patch_size, 1), name='IR')
		model.des(RGB_input, IR_input)
		...
		des2 = tf.compat.v1.summary.image('des_IR', model.IR_des, max_outputs=NUM)
