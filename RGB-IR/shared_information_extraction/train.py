...
def train_descriptor(model, sess, trainset, merged1=None, writer=None, saver=None, save_path=None, EPOCHES=20):
	...
	var_list_ir = tf.contrib.framework.get_trainable_variables(scope='des_extract/IR_Encoder')
	var_list_descriptor = var_list_rgb + var_list_ir
	# print('RGB_Encoder var_list:')
	# for v in var_list_rgb:
	# 	print(v.name)
	# print('\nIR_Encoder var_list:')
	# for v in var_list_ir:
	# 	print(v.name)
