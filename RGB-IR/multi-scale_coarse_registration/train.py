...
def train_affine_network(model, sess, trainset, merged1=None, writer=None, saver=None, save_path=None,
						 task1_model_savepath = None, EPOCHES=20):
	...
	could_load, checkpoint_counter = load(sess=sess, saver=saver1, checkpoint_dir=task1_model_savepath)
	...
	for epoch in range(EPOCHES):
		...
		for batch in range(n_batches):
			...
			FEED_DICT = {model.RGB: rgb_batch, model.IR: ir_batch, model.lr: lr}
